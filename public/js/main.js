...
new _vue2.default({
	...
	methods: {
		add: function add() {
			...
			this.$http.post('/admins/users', postData).then(function (response) {
				alert("Done Add!");
				_this.name = '';
				_this.email = '';
				_this.password = '';
...
},{"../../views/test.vue":7,"vue":5,"vue-resource":3,"vue-validator":4}],7:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-e33652e2", module.exports)
  } else {
    hotAPI.update("_v-e33652e2", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
